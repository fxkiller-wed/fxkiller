	...
	return (
		...
		>
			...
			>
				...
				<div className="w-full flex flex-col justify-center items-center gap-5 font-urbanist text-lg lg:text-2xl">
					...
					<div className="w-full sm:w-[800px] text-center text-gray-100">
